...
namespace StepCore.Data.Migrations
{
    ...
    [Migration("20201115042111_RecommendedBy field is not required in Applicants entitie, UsersId foreign Key added to Applicants entitie ")]
    partial class RecommendedByfieldisnotrequiredinApplicantsentitieUsersIdforeignKeyaddedtoApplicantsentitie
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StepCore.Entities.Roles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StepCore.Entities.UserRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StepCore.Entities.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StepCore.Entities.LaborExperiences", b =>
                {
                    ...
                    b.HasOne("StepCore.Entities.Users", "Users")
                        .WithMany()
            ...
            modelBuilder.Entity("StepCore.Entities.UserRoles", b =>
                {
                    b.HasOne("StepCore.Entities.Roles", "Role")
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StepCore.Entities.Users", "User")
                        .WithMany()
